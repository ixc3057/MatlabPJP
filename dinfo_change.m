...
indir = ['C:\Users\ichen\Documents\data_anon\Patient_0', num2str(patient_number) '\Abdomen_SB_Fx', num2str(fraction_number),'_Delivery']
...
dinfo.StructureSetROISequence.Item_19.ROIName = 'DUODENUM_FX1';
disp(dinfo.StructureSetROISequence.Item_19.ROIName)
dir_dd_name = [indir '\' dd.name];
disp(dir_dd_name)
I = [1 1; 1 1];
dicomwrite(I,dir_dd_name,dinfo);